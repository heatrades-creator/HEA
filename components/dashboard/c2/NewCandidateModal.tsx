      ...
      <div className="bg-white border border-[#e5e9f0] rounded-xl w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input value={form.full_name} onChange={e => set('full_name', e.target.value)} className="w-full bg-[#eef0f5] border border-[#e5e9f0] rounded-lg px-3 py-2 text-[#111827] text-sm placeholder:text-[#6b7280] focus:outline-none focus:border-[#ffd100]" placeholder="Full name" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="email" value={form.email} onChange={e => set('email', e.target.value)} className="w-full bg-[#eef0f5] border border-[#e5e9f0] rounded-lg px-3 py-2 text-[#111827] text-sm placeholder:text-[#6b7280] focus:outline-none focus:border-[#ffd100]" placeholder="email@example.com" />
            </div>
          </div>
          <div>
            <label className="block text-[#374151] text-xs uppercase tracking-wider mb-1.5">Role Applied For</label>
            <input value={form.role_applied} onChange={e => set('role_applied', e.target.value)} className="w-full bg-[#eef0f5] border border-[#e5e9f0] rounded-lg px-3 py-2 text-[#111827] text-sm placeholder:text-[#6b7280] focus:outline-none focus:border-[#ffd100]" placeholder="e.g. Electrician – Solar Installer" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-[#374151] text-xs uppercase tracking-wider mb-1.5">Type</label>
            ...
            <div>
              <label className="block text-[#374151] text-xs uppercase tracking-wider mb-1.5">Source</label>
          ...
          <div>
            ...
            <textarea value={form.notes} onChange={e => set('notes', e.target.value)} rows={2} className="w-full bg-[#eef0f5] border border-[#e5e9f0] rounded-lg px-3 py-2 text-[#111827] text-sm placeholder:text-[#6b7280] focus:outline-none focus:border-[#ffd100] resize-none" />
          </div>
